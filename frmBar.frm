...
Private Sub mnuSub_apiFunctions_Click(Index As Integer)
  ...
  With frmCodeHolder
      Select Case Index
          ...
          Case Is = 200 'general subclass
              Call SendData(.subclassBasic.Text)
              
          Case Is = 201
              Call SendData(.generalTwipToPix)
          
          Case Is = 202
              Call SendData(.generalTextboxNumbersOnly)
          
          Case Is = 300 'graphics: color to html
              Call SendData(.graphicsColorToHtml.Text)
              
          Case Is = 400 'menu into columns
              Call SendData(.menuMakeColumns.Text)
              
          Case Is = 500 'get browsers hwnd and hdc
              Call SendData(.browserGetHwnd.Text)
      
          Case Is = 600 'is array initialized
